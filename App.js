  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <Image source={require('./assets/images/imagem11.JPG')} style={styles.image} />
        <Image source={require('./assets/images/filme02.jpg')} style={styles.image} />
        <Image source={require('./assets/images/filme12.jpg')} style={styles.image} />
      ...
      <View style={styles.contentContainer}>
        <Image source={require('./assets/images/imagem06.jpg')} style={styles.image} />
